...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/query/heroes.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.heroesQuery = void 0;
var heroesQuery = function heroesQuery() {
  return JSON.stringify({
    query: "{\n      constants {\n        heroes {\n          id\n          shortName,\n          stats {\n            complexity,\n            attackType,\n            primaryAttribute\n          }\n        }\n      }\n    }"
  });
};
exports.heroesQuery = heroesQuery;
...
},{"./config.js":"src/config.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _heroes = require("./query/heroes.js");
var _config = require("./config.js");
...
// dom list
var heroListNode = document.getElementsByClassName("hero-list")[0];
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _utils.getGraphqlData)((0, _heroes.heroesQuery)());
        case 2:
          heroesData = _context.sent;
          // set data to hero list node
          heroListNode.innerHTML = "\n    ".concat(filterHeroesBasePrimaryAttr(heroesData.data.constants.heroes, "str"), "\n    ").concat(filterHeroesBasePrimaryAttr(heroesData.data.constants.heroes, "agi"), "\n    ").concat(filterHeroesBasePrimaryAttr(heroesData.data.constants.heroes, "int"), "\n  ");
        case 4:
        case "end":
          return _context.stop();
      }
...
var filterHeroesBasePrimaryAttr = function filterHeroesBasePrimaryAttr(heroes, primaryAttribute) {
  heroes = heroes.filter(function (hero) {
    return hero["stats"]["primaryAttribute"] === primaryAttribute;
  });
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var heroImgNode = document.createElement("img");
      heroImgNode.setAttribute("src", "".concat(_config.STRATZ_HERO_URL, "/").concat(hero.shortName, "_vert.png"));
...
var complexityNode = document.getElementsByClassName("complexity");
// conver the HTMLCollection to array
var complexities = Array.prototype.slice.call(complexityNode);
complexities.forEach(function (complexity, index, arr) {
  complexity.addEventListener("click", function (e) {
    var st = e.target.getAttribute("data-selected");
    ...
    var activeds = arr.slice(0, index + 1);
    activeds.map(function (a) {
      return a.classList.add("filter-actived");
    });
    ...
    var _iterator2 = _createForOfIteratorHelper(heroCards),
      _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var heroCard = _step2.value;
...
/* heroes list */
},{"./query/heroes.js":"src/query/heroes.js","./config.js":"src/config.js","./constants.js":"src/constants.js","./utils.js":"src/utils.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
